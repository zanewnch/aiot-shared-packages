 ...
 * ```
 */
export declare class ControllerResult<T = any> {
    /** HTTP 狀態碼 */
    status: number;
    /** 回應訊息 */
    message: string;
     ...
     * @returns ControllerResult 實例
     */
    static unauthorized(message?: string): ControllerResult;
    /**
     ...
     * @returns ControllerResult 實例
     */
    static forbidden(message?: string): ControllerResult;
    /**
     ...
     * @returns ControllerResult 實例
     */
    static notFound(message?: string): ControllerResult;
    /**
     * 創建衝突回應（409 Conflict）
     *
     * @param message 衝突訊息
     ...
     * @returns ControllerResult 實例
     */
    static internalError(message?: string): ControllerResult;
    /**
     * 轉換為 JSON 物件
     *
