 ...
 * @since 2025-07-26
 */
import type { PaginationInfo } from '../types/PaginationTypes.js';
import type { ApiResponseFormat } from '../types/ApiResponseTypes.js';
/**
 * 請求結果處理類別
 *
 * @class ReqResult
 ...
 * ```
 */
export declare class ReqResult<T = any> {
    /** HTTP 狀態碼 */
